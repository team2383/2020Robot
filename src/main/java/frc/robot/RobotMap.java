...
public class RobotMap {
  ...
  // CONSTANTS
  public static double kDrive_Motion_P = 0.6;				// 1.4%/ft
  ...
  public static double kDrive_Motion_turnP = 0.025;//0.0175 original value
  ...
  public static double kDrive_peakOutput = 0.8; //0.8
  public static double kDrive_Motion_talonP = 0.7;			//0.7  %/ft
	public static double kDrive_Motion_talonI = 0.002;			//0.002 natives
  public static double kDrive_Motion_talonD = 15;       //15
