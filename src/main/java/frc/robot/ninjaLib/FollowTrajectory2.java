...
import static frc.robot.HAL.*;
import static frc.robot.HAL.navX;
//import static frc.robot.HAL.drivetrain;

import frc.robot.ninjaLib.PathFollower;
//import frc.robot.ninjaLib.PathFollowerOLD;
...
public class FollowTrajectory2 extends Command implements Sendable  {
	...
	public FollowTrajectory2(Supplier<Trajectory> trajectorySupplier) {
		this(trajectorySupplier, false, 0);
	}
	
	public FollowTrajectory2(Trajectory trajectory) {
		this(() -> trajectory, false, 0);
	}
	
	public FollowTrajectory2(Trajectory trajectory, boolean backwards) {
		this(() -> trajectory, backwards, 0);
	}
	
	public FollowTrajectory2(Supplier<Trajectory> trajectorySupplier, double startingAngle) {
		this(trajectorySupplier, false, startingAngle);
	}
	
	public FollowTrajectory2(Trajectory trajectory, double startingAngle) {
		this(() -> trajectory, false, startingAngle);
	}
	
	public FollowTrajectory2(Trajectory trajectory, boolean backwards, double startingAngle) {
	 ...
	 */
	public FollowTrajectory2(Supplier<Trajectory> trajectorySupplier, boolean backwards, double startingAngle) {
