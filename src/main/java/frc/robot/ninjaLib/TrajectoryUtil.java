...
public class TrajectoryUtil
{
    ...
    * Return: the desired motor rpm
    */
    public static double getDesiredMotorRPM(double kP, double desiredBallVelocity)
    {
        final double k = 0.0; 
